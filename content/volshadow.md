...
Early in the morning, from certain viewpoints, the [CN Tower](https://en.wikipedia.org/wiki/CN_Tower) in Toronto casts a volumetric shadow in the air.
...
![A spotlight shining in the dark through a cloud of mist, casting a volumetric light in the mist](/media/spotlight_in_smoke.webp)
...
Volumetric shadows occur under the same conditions as volumetric light, but when an object (like a cloud or a 553 meter tall concrete spire) occludes the path of the light source. Because the rest of the air is volumetrically lit, the space that isn't appears to be in shade.

![Beams of volumetric light over a lake](/media/crepuscular_rays.webp)

When the light source is the sun, a volumetric light is called a [crepuscular ray](https://en.wikipedia.org/wiki/Crepuscular_rays). Crepuscular rays are a form of natural volumetric lighting, and they occur when the sun is at an oblique angle (dawn or dusk) and the air contains particulate matter. 

The particulate matter in my CN tower photo was almost certainly air pollution. Toronto has remarkably clean air for a city of 3 million people, but it still evidently has enough airborne particles to cause their giant tower to cast a volumetric shadow.

## Conclusion

In 2015, the Canadian Broadcasting Corporation published [this story](https://www.cbc.ca/news/canada/toronto/what-was-this-beam-radiating-from-the-cn-tower-1.3242665) about a very similar photo of the CN Tower casting a volumetric shadow. 

The CBC's article is 136 words in total, makes multiple inexplicable Star Trek references, doesn't offer any kind of explanation as to why the shadow was volumetric, misuses the word "exude", and primarily focuses on debunking the claim that the CN Tower is secretly a giant shadow flashlight.
